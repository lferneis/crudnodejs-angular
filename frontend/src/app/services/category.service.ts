...
export class CategoryService {
  ...
  /* // Agrega un nuevo método para obtener información de la categoría
  getCategoryById(categoryId: number): Observable<Category> {
    return this.http.get<Category>(`${this.myAppUrl}/api/Categorias/${categoryId}`);
  } */
  ...
  updateProduct(id: number, category: Category): Observable<void> {
